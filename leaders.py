...
# Иконки периодов
_PERIOD_ICONS = {
    "today":     ("5382194935057372936", "📅"),
    "yesterday": ("5382194935057372936", "📆"),
    "week":      ("5438571934210082705", "🔥"),
    "month":     ("5449683594425410231", "🏆"),
    "alltime":   ("5325547803936572038", "👑"),
}
...
def leaders_text(category: str, period: str, viewer_uid: int | None = None) -> str:
    ...
    for i, row in enumerate(leaders):
        ...
        table_lines.append(f'{place_str} {name_str} — {_value_icon(category)} {val_str}{me_mark}')
