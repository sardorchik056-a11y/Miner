...
# ============================================================
_E = {
    "case":       "5445221832074483553",   # 📦 кейс         (EMOJI_BTN_INV)
    "xp_case":    "5445221832074483553",   # 🔮 XP-кейс      (EMOJI_BTN_INV)
    "boost":      "5206607081334906820",   # ⚡ ускоритель   (EMOJI_BTN_ACTIVE / EMOJI_SELECTED)
    "xp_boost":   "5206607081334906820",   # 🔮 XP-ускоритель
    "xp_instant": "5199552030615558774",   # ✨ опыт          (EMOJI_COIN)
    "coin":       "5199552030615558774",   # 💰 монеты        (EMOJI_COIN)
    "stats":      "5206607081334906820",   # 📊 статистика
    "luck":       "5206607081334906820",   # 🍀 удача
    ...
    "warn":       "5240241223632954241",   # ⚠️ предупреждение (EMOJI_NOT_BOUGHT)
    "ok":         "5206607081334906820",   # ✅ ok            (EMOJI_BTN_ACTIVE)
    "cancel":     "5240241223632954241",   # ❌ отмена        (EMOJI_NOT_BOUGHT)
    "shop":       "5199552030615558774",   # 🛒 магазин       (EMOJI_COIN)
    "back":       "6039539366177541657",   # ◀️ назад         (EMOJI_BACK)
